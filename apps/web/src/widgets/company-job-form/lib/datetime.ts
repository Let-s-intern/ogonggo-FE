 ...
 *
 * `CreateCompanyJobRequest.recruitmentStartAt`·`recruitmentEndAt` 은 일시인데 목업의 칸은
 * 날짜 하나이고, 칸 아래 안내가 `마감 시간은 23:59로 설정됩니다.` 라고 적고 있다. 그 23:59 를
 * 붙이는 자리가 여기다.
 *
