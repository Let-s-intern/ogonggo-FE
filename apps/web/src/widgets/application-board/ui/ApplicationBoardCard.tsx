 ...
 *
 * 카드 전체가 링크다. 칸에서 빼는 `X` 는 이 링크 밖의 형제로 둔다(`ApplicationBoardColumn`) —
 * 링크 안에 버튼을 두면 잘못된 마크업이고 누를 때 이동까지 함께 일어난다.
 */
export function ApplicationBoardCard({ item }: ApplicationBoardCardProps) {
