 ...
 *
 * 문구 자체는 `shared/lib/placeholderNotice.ts` 로 옮겼다 — 마이페이지의 다른 두 화면도
 * 같은 말을 쓴다. 이 이름으로 부르던 곳을 그대로 두려고 여기서 다시 내보낸다.
 */
export { PLACEHOLDER_NOTICE } from '@/shared/lib/placeholderNotice';
