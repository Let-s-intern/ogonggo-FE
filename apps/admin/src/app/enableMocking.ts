 ...
 * 목데이터를 켤지 정한다.
 *
 * **끄라고 하지 않는 한 켜진다. 개발이든 배포든 같다.** 아홉 메뉴 중 백엔드가 있는 것은 넷이다 —
 * 채용공고·부트캠프·검수 대기·반려 보관. 목을 끄면 이 넷은 실제 데이터로 그려지고, 나머지
 * 다섯(대시보드·사이드·스터디·일반 회원·비즈니스 회원·공지사항)은 부를 API 가 없어 비어 있다.
 *
